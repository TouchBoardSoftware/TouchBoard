...
public class Frames {
    ...
    * one == null, the only option available will be Option.OK. If the dialog is
    * closed, this will return Option.Closed. This will never return null.
    */
