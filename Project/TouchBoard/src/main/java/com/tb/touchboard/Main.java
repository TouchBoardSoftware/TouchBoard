  ...
  public static void main(String[] arguments) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        // Enforce java 1.8
        /**
         * Why: Java 17, at least in the Temurin platform, appears to have a bug where TouchBoard
         * cannot type capital letters while the user is simultaneously moving the mouse pointer.
         * The letters are incorrectly typed lowercase if the mouse pointer is in motion. However,
         * this does not occur when TB is run using Java 1.8 (aka Java 8).
         */
