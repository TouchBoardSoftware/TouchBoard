...
public class CommandCenter {
   ...
   *
   * This takes a string virtualKeyCode, representing one of the static public final int virtual key
   * code fields from the KeyEvent class. This string can be in any case, and can optionally omit
   * the "VK_" prefix.
   *
   ...
   *
   * Returns: the integer value of the virtual key code or null. A null return value probably means
   * that the specified virtual key code does not exist.
   */
