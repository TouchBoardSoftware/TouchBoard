...
public class Constants {
    ...
    static final public ImageIcon lockOpen
            = Use.createImageIcon("/images/lockopen.gif", "");
    static final public ImageIcon lockClosed
            = Use.createImageIcon("/images/lockclosed.gif", "");
    static final public ImageIcon collapseAllArrow
            = Use.createImageIcon("/images/collapseallarrow.gif", "");
    static final public ImageIcon minimizeIcon
            = Use.createImageIcon("/images/minimizeicon.gif", "");
    static final public ImageIcon editButtonIcon
            = Use.createImageIcon("/images/editbuttonicon.gif", "");
    static final public ImageIcon editButtonIconGreen
            = Use.createImageIcon("/images/editbuttonicongreen.gif", "");
    static final public ImageIcon capslockOffIcon
            = Use.createImageIcon("/images/capslockofficon.gif", "");
    static final public ImageIcon capslockOnIcon
            = Use.createImageIcon("/images/capslockonicon.gif", "");
    static final public ImageIcon applicationIcon
            = Use.createImageIcon("/images/applicationicon.gif", "");
