...
public class Use {
  ...
  static public ImageIcon createImageIcon(String path,
      String description) {
    java.net.URL imgURL = Use.class.getResource(path);
    if (imgURL != null) {
  ...
  /**
   * Get an Integer value from a String. This returns null if the digits are not a parsable integer.
   * This also return null if the number is negative and negativeAllowed is false.
   */
